...
__webpack_require__.d(__webpack_exports__, {
    ...
    ClientEventType: ()=>/* reexport */ types_ClientEventType,
    WsSimultInterpretationClient: ()=>/* reexport */ simult_interpretation,
...
external_agora_rtc_sdk_ng_default().disableLogUpload();
external_agora_rtc_sdk_ng_default().setLogLevel(3);
external_agora_rte_extension_namespaceObject.logger.setLogLevel(3);
/**
 ...
 */ const checkDenoiserSupport = (assetsPath)=>{
    ...
    const external = window.__denoiser || new external_agora_extension_ai_denoiser_namespaceObject.AIDenoiserExtension({
...
class VoiceprintFeature extends APIResource {
   ...
   */ // eslint-disable-next-line max-params
    async update(groupId, featureId, params, options) {
        ...
        const response = await this._client.put(apiUrl, (0, external_axios_namespaceObject.toFormData)(params), false, options);
        return response.data;
    }
    /**
...
class WebSocketAPI {
    ...
    constructor(url, options = {}){
        ...
        WebSocketImpl = utils_isBrowser() ? window.WebSocket : class extends external_ws_default() {
...
/**
 * BaseAudioProcessor
 */ class BaseAudioProcessor extends external_agora_rte_extension_namespaceObject.AudioProcessor {
}
...
const oggOpusEncoder_js_namespaceObject = require("opus-encdec/src/oggOpusEncoder.js");
const libopus_encoder_js_namespaceObject = require("opus-encdec/dist/libopus-encoder.js");
var libopus_encoder_js_default = /*#__PURE__*/ __webpack_require__.n(libopus_encoder_js_namespaceObject);
 ...
 */ class OpusAudioProcessor extends base_audio_processor {
    async onNode(node, context) {
        ...
        this.encoder = new oggOpusEncoder_js_namespaceObject.OggOpusEncoder(encoderConfig, libopus_encoder_js_default());
...
class PcmRecorder {
    async start() {
        ...
        if (mediaStreamTrack) {
            if ('function' == typeof mediaStreamTrack) this.audioTrack = await (0, esm_namespaceObject.createCustomAudioTrack)({
                mediaStreamTrack: await mediaStreamTrack()
            });
            else this.audioTrack = await (0, esm_namespaceObject.createCustomAudioTrack)({
                mediaStreamTrack
            });
        } else {
...
const oggOpusDecoder_js_namespaceObject = require("opus-encdec/src/oggOpusDecoder.js");
const libopus_decoder_js_namespaceObject = require("opus-encdec/dist/libopus-decoder.js");
var libopus_decoder_js_default = /*#__PURE__*/ __webpack_require__.n(libopus_decoder_js_namespaceObject);
// @ts-expect-error no types
// @ts-expect-error no types
class OpusDecoder {
    /**
...
class WsChatClient extends chat_base {
    ...
    async connect() {
        ...
        if ('client_interrupt' === this.turnDetection) {
            var _this_wavStreamPlayer2;
            null === (_this_wavStreamPlayer2 = this.wavStreamPlayer) || void 0 === _this_wavStreamPlayer2 || _this_wavStreamPlayer2.setLocalLoopbackEnable(false);
        }
        this.ws.send(event);
